...
// This package holds published private keys for disposable demos and automated
// tests. They are intentionally insecure and must never be used in production,
// shared validation environments, long-lived deployments, or with external
// services. Generate deployment-specific keys for every real deployment.

const demoTCSignerESP256PrivateKeyPEM = `-----BEGIN PRIVATE KEY-----
MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgApZYjZCUGLM50VBC
CjYStX+09jGmnyJPrpDLTz/hiXOhRANCAASEloEarguqq9JhVxie7NomvqqL8Rtv
P+bitWWchdvArTsfKktsCYExwKNtrNHXi9OB3N+wnAUtszmR23M4tKiW
-----END PRIVATE KEY-----`

var demoTAMESP256PrivateCOSEKey = []byte{
...
var demoTrustedAgentESP256PrivateCOSEKey = []byte{
...
var demoAttesterES256PrivateCOSEKey = []byte{
	0xa6, 0x01, 0x02, 0x03, 0x26, 0x20, 0x01, 0x21, 0x58, 0x20,
...
var demoTEEPAgentCodeSigningESP256PrivateCOSEKey = []byte{
	0xa6, 0x01, 0x02, 0x03, 0x28, 0x20, 0x01, 0x21, 0x58, 0x20,
	...
	0x23, 0x58, 0x20,
	0xa9, 0x3e, 0xcf, 0x9d, 0xc1, 0x37, 0x87, 0xaa, 0x36, 0x80, 0x10, 0xa9, 0xf0, 0x2d, 0x6a, 0x09,
	0xb0, 0x34, 0x74, 0x35, 0xc7, 0xca, 0x3a, 0xc2, 0x5e, 0xd4, 0x1f, 0x5a, 0xa3, 0x50, 0xff, 0x36,
}

var demoAppCodeSigningESP256PrivateCOSEKey = []byte{
	0xa6, 0x01, 0x02, 0x03, 0x28, 0x20, 0x01, 0x21, 0x58, 0x20,
	...
	0x23, 0x58, 0x20,
	0xc8, 0x38, 0xa4, 0x96, 0x98, 0x0a, 0x3d, 0x0f, 0xb3, 0x9b, 0xaf, 0x40, 0x84, 0xbf, 0x97, 0x3c,
	0xd1, 0x70, 0x3b, 0x92, 0x5d, 0x99, 0x8b, 0xaa, 0xed, 0x38, 0x85, 0x57, 0x89, 0x35, 0xec, 0xdf,
}

func DemoTCSignerESP256PrivateKeyPEM() []byte {
	return []byte(demoTCSignerESP256PrivateKeyPEM)
}

func DemoTAMESP256PrivateCOSEKey() []byte {
	return clone(demoTAMESP256PrivateCOSEKey)
}

func DemoTrustedAgentESP256PrivateCOSEKey() []byte {
	return clone(demoTrustedAgentESP256PrivateCOSEKey)
}

func DemoAttesterES256PrivateCOSEKey() []byte {
	return clone(demoAttesterES256PrivateCOSEKey)
}

func DemoTEEPAgentCodeSigningESP256PrivateCOSEKey() []byte {
	return clone(demoTEEPAgentCodeSigningESP256PrivateCOSEKey)
}

func DemoAppCodeSigningESP256PrivateCOSEKey() []byte {
	return clone(demoAppCodeSigningESP256PrivateCOSEKey)
}
